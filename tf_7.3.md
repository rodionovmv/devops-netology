```commandline
C:\Users\red_hat\learn-terraform-iam-policy>terraform workspace list
  default
* prod
  stage
```
...
data.aws_iam_policy_document.example: Read complete after 0s [id=1583621631]
data.aws_ami.ubuntu: Read complete after 0s [id=ami-017fecd1353bcc96e]
data.aws_caller_identity.current: Read complete after 0s [id=951728628080]
...
https://github.com/rodionovmv/terraform/tree/main/Bucket_S3